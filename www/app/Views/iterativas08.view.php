<!--Inicio HTML -->
                                ...
                                <div class="row">
                                    <div class='col-12'>
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            <?php foreach ($resultado['asignaturas'] as $nombreAsignatura => $datosAsignatura) { ?>
                                                <tr>
                ...
                <div class="col-lg-4 col-12">
                        <div class="card bg-gradient-success">
                            ...
                            <div class="card-body">
                                <ul>
                                <?php foreach ($resultado['suspensos'] as $alumno => $suspensos) { ?>
                                    <p>
                                        <?php if ($suspensos === 0) { ?>
                        ...
                        <div class="card bg-gradient-warning">
                            <div class="card-header">
                                <h6 class="m-0 font-weight-bold text-white">Suspensos</h6>
                            </div>
                            <div class="card-body">
                                <ul>
                                    <?php foreach ($resultado['suspensos'] as $alumno => $suspensos) { ?>
                        ...
                        <div class="card bg-gradient-danger">
                            <div class="card-header">
                                <h6 class="m-0 font-weight-bold text-white">No promocionan</h6>
                            </div>
                            <div class="card-body">
                                <ul>
                                    <?php foreach ($resultado['suspensos'] as $alumno => $suspensos) { ?>
